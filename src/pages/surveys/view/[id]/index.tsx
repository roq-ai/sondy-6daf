...
import { getSurveyById } from 'apiSdk/surveys';
...
function SurveyViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<SurveyInterface>(
    () => (id ? `/surveys/${id}` : null),
    () =>
      getSurveyById(id, {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('survey', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/surveys/edit/${id}`} passHref legacyBehavior>
                    <Button
