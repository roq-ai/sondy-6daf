  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Insights, Drive Decisions with sondy - Your Ultimate Platform for Conducting and Analyzing Surveys."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdXJ2ZXl8ZW58MHx8fHwxNjkyMzEyMzk5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Insights, Drive Decisions with sondy - Your Ultimate Platform for Conducting and Analyzing Surveys.`}
            </Text>
            <Box
