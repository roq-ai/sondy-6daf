          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Option 1" text={data?.option_1} />

                <FormListItem label="Option 2" text={data?.option_2} />

                <FormListItem label="Option 3" text={data?.option_3} />

                <FormListItem label="Option 4" text={data?.option_4} />
                ...
                {hasAccess('survey', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Survey"
                    text={
                      <Link as={NextLink} href={`/surveys/view/${data?.survey?.id}`}>
                        {data?.survey?.title}
                      </Link>
                    }
                  />
