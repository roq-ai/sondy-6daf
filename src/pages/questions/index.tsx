...
export function QuestionListPage(props: QuestionListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getQuestions({
        relations: ['survey', 'response.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'option_1', header: 'Option 1', accessorKey: 'option_1' },
    { id: 'option_2', header: 'Option 2', accessorKey: 'option_2' },
    { id: 'option_3', header: 'Option 3', accessorKey: 'option_3' },
    { id: 'option_4', header: 'Option 4', accessorKey: 'option_4' },
    hasAccess('survey', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'survey',
          header: 'Survey',
          accessorKey: 'survey',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/surveys/view/${record.survey?.id}`}>
              {record.survey?.title}
            </Link>
          ),
        }
